...
\begin{experiences}
  \experience
    {Present}   {\website{https://www.analog.com/en/index.html}{Analog Devices Inc.}| Analog Garage, Digital HealthCare}{Senior Software Engineer}{Santa Clara, CA}
    {October 2017} {
                      \begin{itemize}
                        ...
                        \item Work with a multidisciplinary team for developing prototypes to demonstrate and evolve new internal technology proposals and external startup engagements. Includes designing hardware break-out boards, writing C/C++ firmware code, digital modeling of hardware using Verilog/VHDL and Python scripting
                      \end{itemize}
                    }
