...
\begin{projects}
	...
	{}
	{Evaluate architectural optimizations to detect High Amplitude Audio Impulses in an indoor scenario. Point man for Analog Garage on evaluating advanced on-edge AI micro-processors, and ultra-low power sensory front-ends to enable battery operated, IoT devices opening doors to a myriad of applications. Initial development of models and feature evaluation is deployed on Amazon Web Services. The project is currently in the Angel phase}
	{AWS, Amazon SageMaker, AI-DNNs, Tensorflow, Scikit, MEMS MICS, }
	...
	{3-axis Accelerometers, Direct Acyclic Graph (DAG), Audio Processing, Machine Learning, Modular Architecture, Test-Driven Programming}
	...
	{Gumstix Verdex Pro, Raspberry Pi, QT }
	...
	{HDMI, Xilinx FPGA, Nexys Project, Digital Modeling}
\end{projects}
